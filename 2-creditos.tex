...
\textbf{tradução©}\quad			 			 {Marcus Mazzari}\\
\textbf{introdução}\quad			 		 {Ricardo Musse}\\
%\textbf{posfácio©}\quad			 		 {}\\
%\textbf{ilustração©}\quad			 		 {copyrightilustracao}\medskip

\textbf{título original}\quad			 	 {\emph{Manifest der Kommunistischen Partei} (1848)}\\
...
\textbf{\textsc{isbn}}\quad			 		 {978-65-89705-64-2}
