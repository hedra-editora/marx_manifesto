...
\hfill 
\textit{Londres, 24 de junho de 1872}\\
\textsc{karl marx e friedrich engels}
...
\hfill 
\textit{Londres, 28 de junho de 1883}\\
\textsc{friedrich engels}
...
\textit{Gátchina}, situada a 40 km ao sul de São Petersburgo. [\textsc{n.\,t.}]}   e a Rússia representa a vanguarda da ação revolucionária da
Europa.
...
\hfill 
\textsc{friedrich engels}
\textit{Londres, 1º de maio de 1890}
...
de contraporem ao conto da carochinha\footnote{\textit{Conto da carochinha} corresponde no original a \textit{Märchen}, forma
...
\textit{fairy"-tale}, em inglês; \textit{sprookje}, em holandês. Em português traduz"-se como conto de \textit{fadas}, \textit{carochinha} ou \textit{conto
...
por Samuel Moore, a qual, embora \textit{autorizada} e prefaciada por
...
1888 consta aqui: ``em classe dirigente da nação''. [\textsc{n.\,t.}]} constituir"-
...
no original (Cf.~nota 11 na p.~\pageref{8}). [\textsc{n.\,t.}]} e o estamento dos pequenos camponeses
