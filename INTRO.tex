...
desencadeou pouco menos de um mês após sua redação.\looseness=-1
...
interpretação econômica da história e a moderna teoria da política.\looseness=-1
...
entre oprimidos e opressores.\looseness=-1
...
lógico e o histórico e concedendo primazia ao primeiro.\looseness=-1
...
industriais inteiros, os burgueses modernos''\looseness=-1
\item A partir das
...
liberdade de denominar esses movimentos de \textit{expansão intensiva e extensiva}.\looseness=-1
...
armas --- os operários modernos, os \textit{proletários}.\footnote{Ver p.\,\pageref{4}.}\looseness=-1
\end{quote} 
...
configurado pelos valores necessários à mera reprodução da espécie.\looseness=-1

\textls[-10]{A formação política do proletariado, descrita no \textit{Manifesto do
...
como um objetivo descolado da necessidade de superar esses obstáculos.}\looseness=-1
...
histórico do mundo moderno.\looseness=-1
...
condições inerentes a sua situação no capitalismo.\looseness=-1
...
as esferas da vida, isto é, para todos os setores da sociedade.\looseness=-1
...
tradução com Alfredo Bosi.\looseness=-1
