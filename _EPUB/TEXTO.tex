\title{Manifesto comunista}

\author{Karl Marx e Friedrich Engels}

\chapter{}

Marcus Mazzari (\textit{tradução})
              
Ricardo Musse (\textit{introdução})

\chapter{}

\textbf{edição brasileira©} Hedra 2022\\
\textbf{tradução©} Marcus Mazzari\\
\textbf{introdução} Ricardo Musse\\

\textbf{título original} \emph{Manifest der Kommunistischen Partei} (1848)\\

\textbf{edição} Jorge Sallum\\
\textbf{coedição} Suzana Salama\\
\textbf{assistência editorial} Paulo Henrique Pompermaier\\
\textbf{revisão} Iuri Pereira\\
\textbf{capa} Lucas Kroëff\\

\textbf{\textsc{isbn}} 978-65-89705-64-2
...
sólido desmancha no ar''. Muito do interesse e parte da recepção desse
...
palavra, ela cria para si um mundo à sua própria imagem e semelhança.
\end{quote} 
...
armas --- os operários modernos, os \textit{proletários}.
\end{quote} 
...
comunistas em relação aos diversos partidos oposicionistas (segmento \textsc{iv}),
...
isso preceda o próprio \textit{Manifesto}.
...
conto maravilhoso de inverno}. No terceiro capítulo, Heine
...
no original.} e o estamento dos pequenos camponeses
...
em sentido figurado. Na edição de 1888 encontra-se substituída 
