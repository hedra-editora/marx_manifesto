\SVN $Id: TEXTO.tex 8210 2011-02-03 15:56:28Z oliveira $



\chapter[Prefácio à edição alemã de 1872]{Prefácio \subtitulo{$[$à edição alemã de 1872$]$}}
\hedramarkboth{Manifesto comunista}{Marx e Engels}
...
revolucionárias propostas no final do segmento \versal{II}. Sob muitos aspectos,
...
comunistas em relação aos diversos partidos oposicionistas (\mbox{segmento \versal{IV}}),
...
\chapter[Prefácio à edição alemã de 1883]{Prefácio \subtitulo{$[$à edição alemã de 1883$]$}}
...
\chapter[Prefácio à edição alemã de 1890]{Prefácio \subtitulo{$[$à edição alemã de 1890$]$}}
...
\chapter[Manifesto do Partido Comunista]{Manifesto do\break Partido Comunista}
\hedramarkboth{Manifesto comunista}{Marx e Engels}
...
\section[Burgueses e proletários]{Burgueses e proletários\NoCaseChange{\normalfont\normalsize\protect\footnote{Por
...
assalariado. Por proletariado, compreende"-se a classe dos modernos
...
paliçadas”) aparecem, a partir da segunda metade do século \versal{XIX}, em
...
sucumbiam no século \versal{XVIII} às ideias iluministas, a sociedade feudal
...
proveniente do século \versal{XVI} e desde esse tempo despontando aqui de forma sempre 
...
Proletariado\footnote{ Trata"-se do segmento \versal{I} “Burgueses e
proletários”. [N.~do~T.]}).
...
mais desenvolvido do que tinha a Inglaterra no século \versal{XVII} e a França
